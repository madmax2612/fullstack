        ...
        React.createElement(Table, { style: {
            ...
            !collapse && (React.createElement("tbody", null,
                ...
                fieldsValues && !isUndefined(fieldsValues[name]) && (React.createElement("tr", null,
                    ...
                    React.createElement("td", { style: Object.assign({ display: 'block', maxWidth: 100 }, paraGraphDefaultStyle) }, value))),
                readFormStateRef.current.touched && (React.createElement("tr", null,
                    ...
                    React.createElement("td", null,
                        React.createElement("code", { style: Object.assign({ fontSize: 12, color: isTouched ? colors.green : colors.lightPink }, paraGraphDefaultStyle) }, isTouched ? 'true' : 'false')))),
                readFormStateRef.current.dirtyFields && (React.createElement("tr", null,
                    ...
                    React.createElement("td", null,
                        React.createElement("code", { style: Object.assign({ fontSize: 12, color: isDirty ? colors.green : colors.lightPink }, paraGraphDefaultStyle) }, isDirty ? 'true' : 'false')))))))));
};
