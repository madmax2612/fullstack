...
function logStartAction({ debugName, getStore, }) {
...
const DevToolActionPanel = ({ setStateIndex, stateIndex, actions, config, }) => {
    const [filterName, setFilterName] = React.useState(config.filterAction);
    return (React.createElement("div", { style: {
        ...
        React.createElement("p", { style: {
            ...
            " Actions"),
        React.createElement("input", { name: "filter", type: "search", style: {
                borderRadius: 0,
                background: '#11334c',
                marginTop: 0,
                border: 'none',
        ...
        React.createElement("ul", { style: {
            ...
            filterName === '') &&
            data.name)
            .map(({ name }, index) => (React.createElement("li", { style: {
                fontSize: 13,
                padding: 0,
            }, key: `${name}${index}` },
...
function DevToolStorage({ setLoadPanel, isBrowser }) {
    return (React.createElement("div", { style: {
        ...
        React.createElement("ul", { style: {
                ...
                fontSize: 14,
                lineHeight: 1.5,
            } }, isBrowser && Object.entries(window.localStorage).map(([key, value], index) => (React.createElement("li", { key: `${key}${index}` },
            React.createElement("button", { style: {
                    padding: 10,
                    margin: '0 0 20px',
                    width: '100%',
...
var DevToolStateTree = ({ setPanel, isLoadPanelShow, setLoadPanel, state, setExpand, isCollapse, closePanel, stateIndex, actions, config, panelPosition, isBrowser, }) => {
    ...
    const [filterValue, setFilterValue] = React.useState(config.searchTerm);
    let data = ((stateIndex === -1 ? actions[actions.length - 1] : actions[stateIndex]) ||
        {}).state;
    if (filterValue)
        data = search(clone(data), filterValue);
    return (React.createElement("section", null,
        isLoadPanelShow && (React.createElement(DevToolStorage, { setLoadPanel: setLoadPanel, isBrowser: isBrowser })),
        React.createElement("h3", { style: {
            ...
            React.createElement("span", { style: { marginRight: 20, float: 'right', display: 'flex' } },
        ...
        React.createElement("section", { style: { padding: '10px 0px 10px 10px' } },
            React.createElement("input", { name: "filter", style: {
                    borderRadius: 0,
                    background: '#11334c',
                    marginTop: 10,
                    border: 0,
            ...
            isBrowser && (React.createElement(ReactJson, { src: data, theme: "harmonic", iconStyle: "square", enableClipboard: false, collapsed: isCollapse, displayObjectSize: false, displayDataTypes: false, indentWidth: 2, style: Object.assign({ fontSize: 12, overflow: 'auto' }, (isBrowser
                    ? {
...
const DevTool = ({ buttonBottom, buttonTop, iconSize, }) => {
    ...
    const mouseDownOriginalX = React.useRef(0);
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(reactSimpleAnimate.Animate, { play: isClose, end: { transform: 'translateX(102%)' }, easeType: "ease-out", duration: 0.3, render: ({ style }) => (React.createElement("div", { style: Object.assign(Object.assign({ zIndex: Z_INDEX.top, position: 'fixed', right: 0, width: 600, height: '100vh', background: COLORS.primary, display: 'grid', gridTemplateColumns: '3px 150px minmax(100px, 1fr)', boxShadow: '0 0 8px 3px #080808' }, (panelPosition === 'bottom'
                ...
                React.createElement(DevToolActionPanel, { config: config, stateIndex: stateIndex, actions: actions, setStateIndex: setStateIndex }),
